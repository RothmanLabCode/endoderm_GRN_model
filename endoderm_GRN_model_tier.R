# C. elegans endoderm development GRN model - Tier model
...
delta <- 3.278295e-02 #Native degradation rate
a1 <- 4.666656e-03 #SKN-1 activation of med-2
a2 <- 3.789606e-02 #SKN-1 activation of med-1
a3 <- 2.546014e-02 #SKN-1 activation of end-3
a4 <- 7.088873e-18 #SKN-1 activation of end-1
a6 <- 3.473743e-02 #MED-2 activation of end-3
a17 <- 4.436445e-18 #MED-2 activation of end-1
a7 <- 2.181668e-17 #MED-1 activation of end-3
a8 <- 2.048436e-01 #MED-1 activation of end-1
a9 <- 7.410022e-02 #POP-1 activation of end-3
a10 <- 8.742976e-17 #POP-1 activation of end-1
a12 <- 1.074840e-01 #END-3 activation of elt-7
a13 <- 1.559075e-17 #END-1 activation of elt-7
a14 <- 5.219584e-02 #END-3 activation of elt-2 adjusted from fitted value of 2.219584e-18
a15 <- 3.344716e-02 #END-1 activation of elt-2
f1 <- 1.185834e-01 #ELT-7 feedback
f2 <- 3.839391e-01 #ELT-2 feedback
theta1 <- 1.216969e+02 #Threshold required for ELT-7 feedback (ppm)
theta2 <- 2.141869e+01 #Threshold required for ELT-2 feedback (ppm)
tau <- 5.184828e+01 #Transcription-activation delay (min)
